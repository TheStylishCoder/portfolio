    ...
    return(
        <div className="about" id="about">
            ...
            <div className="about-content">
                <p>I am a software developer with a love of learning and a keen interest in front end development. I have recently completed CodeClan’s Professional Software Development course which gave me the opportunity to explore a range of languages and technologies including Java, Python, JavaScript and React whilst practising TDD and agile methodologies. 
                    <br/>
                    <br/>
